  ...
  return (
    <section className="relative bg-gray-900 text-white">
      ...
      <div className="relative container mx-auto px-4 py-24 flex flex-col items-center text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">Yeni Sezon Ürünleri</h1>
        <p className="text-xl mb-8 max-w-2xl">En yeni ürünlerimizi keşfedin ve tarzınızı yansıtın. Kalite ve şıklık bir arada.</p>
        <Link 
          to="/products" 
